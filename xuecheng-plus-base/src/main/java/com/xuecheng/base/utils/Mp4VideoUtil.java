...
//        Process p = builder.start();
        ...
        //ffmpeg的路径
        String ffmpeg_path = "/opt/local/bin/ffmpeg";//ffmpeg的安装位置
        //源avi视频的路径
        String video_path = "/Users/hope4cc/Home/xuexitong/ceshi/ceshi.avi";
        //转换后mp4文件的名称
        String mp4_name = "ceshi.mp4";
        //转换后mp4文件的路径
        String mp4_path = "/Users/hope4cc/Home/xuexitong/ceshi/ceshi.mp4";
        //创建工具类对象
        Mp4VideoUtil videoUtil = null;
        try {
            videoUtil = new Mp4VideoUtil(ffmpeg_path,video_path,mp4_name,mp4_path);
        } catch (Exception e) {
            e.printStackTrace();
        }
        //开始视频转换，成功将返回success
